...
const publicEnvSchema = z.object({
  ...
  NEXT_PUBLIC_MAX_DOCUMENT_SIZE_MB: numberStringWithDefault("5"),
  NEXT_PUBLIC_ATTACHMENTS_ENABLED: defaultedBooleanString("false"),
...
function readPublicEnvInput() {
  return {
    ...
    NEXT_PUBLIC_MAX_DOCUMENT_SIZE_MB: process.env.NEXT_PUBLIC_MAX_DOCUMENT_SIZE_MB,
    NEXT_PUBLIC_ATTACHMENTS_ENABLED: process.env.NEXT_PUBLIC_ATTACHMENTS_ENABLED,
