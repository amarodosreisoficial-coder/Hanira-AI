      ...
      <div className="mt-10 grid gap-3 sm:grid-cols-3">
        {prompts.map(({ icon: Icon, title, description, prompt }) => (
          <button
            ...
            className="group flex min-h-32 flex-col rounded-2xl border border-transparent p-4 text-left transition duration-200 hover:bg-card/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
          >
            <span className="grid size-9 place-items-center rounded-xl text-muted-foreground transition group-hover:text-primary">
